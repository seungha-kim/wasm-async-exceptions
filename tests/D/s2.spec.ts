...
test('D/S2: suspend then throw — observed console sequence', async ({ page }) => {
  const lines: string[] = [];
  page.on('console', (msg) => {
  ...
  await page.goto('http://localhost:8080/examples/D/s2/build/index.html');
